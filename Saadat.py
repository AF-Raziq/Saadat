...
def rcrack(ids,passlist):
	...
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;32m [Strat] %s|\033[1;32mOK:-%s \033[1;91m'%(loop,len(oks)));sys.stdout.flush()
			session = requests.Session()
...
def Subscraption():
	key1=open('/data/data/com.termux/files/home/Saadat/Saadat.py",').read()
	clear()
	print(logo)
	...
	if key1 in r1:
		...
		print(logo)
		print ("")
		print(" \033[1;32m RSH Toll Paid You Need Get Approved First\033[1;37m\n")
